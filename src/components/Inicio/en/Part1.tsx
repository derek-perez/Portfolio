            ...
            <div id='textIntro' style={styles.contentPart1}>
                ...
                <div style={{ marginLeft: '50px', width: '80%' }}>
                    ...
                    <p style={{ lineHeight: '1.3' }}>
                        ...
                        I am a Full Stack Web Developer using the "MERN Stack" (or MERN stack) for website development,
                        and I use React Native CLI for mobile app development, (currently only Android apps).
                        <br />
                        <br />
                        And something I like to do is develop <b>artificial intelligence models</b> through neural networks using <b>TensorFlow</b>.
                        I recently finished a course where I spent around 3 months learning it.
                    </p>
                </div>
            </div>
        </div>
