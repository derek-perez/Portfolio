        ...
        <div id='Web_Development Blogi' className="section" style={styles.container}>
            ...
            <div style={{
                ...
                <p id='infoBlogi' className="textHidden" style={styles.infoProyect}>
                    <b>Blogi</b>, was one of my first relevant projects that I did using as Backend: NodeJs. <b>Blogi</b> uses a <b>RESTful </b>
                    which I developed myself and at that time, I still didn't implement in my "React" projects,
                    so for the Frontend I only use: <b>HTML</b>, <b>CSS</b> and <b>JavaScript</b>. <b>Blogi</b> is a blog manager where you can
                    host your personal blogs and also see those of other users, has a forum and is also a <b>PWA</b> with <b>PUSH Notifications</b>,
                    among other things...
                    <br />
                    <br />
                    Of course, to create a blog, you must choose a plan, the "Premium Plan" is paid, and a MercadoPago window will appear, but it is only for testing.
                </p>
